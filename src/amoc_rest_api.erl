...
validate_response('addUsers', 200, Body, ValidatorState) ->
    validate_response_body('', '', Body, ValidatorState);
validate_response('addUsers', 409, Body, ValidatorState) ->
    validate_response_body('', '', Body, ValidatorState);
validate_response('addUsers', 500, Body, ValidatorState) ->
    validate_response_body('Error', 'Error', Body, ValidatorState);
validate_response('removeUsers', 200, Body, ValidatorState) ->
    validate_response_body('', '', Body, ValidatorState);
validate_response('removeUsers', 409, Body, ValidatorState) ->
    validate_response_body('', '', Body, ValidatorState);
validate_response('removeUsers', 500, Body, ValidatorState) ->
    validate_response_body('Error', 'Error', Body, ValidatorState);
validate_response('startScenario', 200, Body, ValidatorState) ->
    validate_response_body('', '', Body, ValidatorState);
validate_response('startScenario', 409, Body, ValidatorState) ->
    validate_response_body('', '', Body, ValidatorState);
validate_response('startScenario', 500, Body, ValidatorState) ->
    validate_response_body('Error', 'Error', Body, ValidatorState);
validate_response('stopScenario', 200, Body, ValidatorState) ->
    validate_response_body('', '', Body, ValidatorState);
validate_response('stopScenario', 409, Body, ValidatorState) ->
    validate_response_body('', '', Body, ValidatorState);
validate_response('stopScenario', 500, Body, ValidatorState) ->
    validate_response_body('Error', 'Error', Body, ValidatorState);
validate_response('updateSettings', 200, Body, ValidatorState) ->
    validate_response_body('', '', Body, ValidatorState);
validate_response('updateSettings', 409, Body, ValidatorState) ->
    validate_response_body('', '', Body, ValidatorState);
validate_response('updateSettings', 500, Body, ValidatorState) ->
    validate_response_body('Error', 'Error', Body, ValidatorState);
validate_response('getAvailableScenarios', 200, Body, ValidatorState) ->
    validate_response_body('ScenarioList', 'ScenarioList', Body, ValidatorState);
validate_response('getScenarioDescription', 200, Body, ValidatorState) ->
    validate_response_body('ScenarioInfo', 'ScenarioInfo', Body, ValidatorState);
validate_response('getScenarioDescription', 404, Body, ValidatorState) ->
    validate_response_body('', '', Body, ValidatorState);
validate_response('getScenarioSettings', 200, Body, ValidatorState) ->
    validate_response_body('ScenarioDefaults', 'ScenarioDefaults', Body, ValidatorState);
validate_response('getScenarioSettings', 404, Body, ValidatorState) ->
    validate_response_body('', '', Body, ValidatorState);
validate_response('uploadNewScenario', 200, Body, ValidatorState) ->
    validate_response_body('UploadResp', 'UploadResp', Body, ValidatorState);
validate_response('uploadNewScenario', 400, Body, ValidatorState) ->
    validate_response_body('Error', 'Error', Body, ValidatorState);
validate_response('getAmocAppStatus', 200, Body, ValidatorState) ->
    validate_response_body('AmocStatus', 'AmocStatus', Body, ValidatorState);
validate_response('getAmocAppStatusOnNode', 200, Body, ValidatorState) ->
    validate_response_body('AmocStatus', 'AmocStatus', Body, ValidatorState);
validate_response('getAmocAppStatusOnNode', 404, Body, ValidatorState) ->
    validate_response_body('', '', Body, ValidatorState);
validate_response('getClusteredNodes', 200, Body, ValidatorState) ->
...
request_params('addUsers') ->
    [
        'ExecutionChangeUsers'
    ];
request_params('removeUsers') ->
    [
        'ExecutionChangeUsers'
    ];
request_params('startScenario') ->
    [
        'ExecutionStart'
    ];
request_params('stopScenario') ->
    [
    ];
...
request_params('getAvailableScenarios') ->
    [
    ];
request_params('getScenarioDescription') ->
    [
        'id'
    ];
request_params('getScenarioSettings') ->
    [
        'id'
    ];
request_params('uploadNewScenario') ->
    [
        'file'
    ];
request_params('getAmocAppStatus') ->
    [
    ];
request_params('getAmocAppStatusOnNode') ->
    [
        'node'
    ];
request_params('getClusteredNodes') ->
    [
    ];
request_params(_) ->
    error(unknown_operation).
...
request_param_info('addUsers', 'ExecutionChangeUsers') ->
    #{
        source => body,
        rules => [
            {schema, object, <<"#/components/schemas/ExecutionChangeUsers">>},
            required
        ]
    };
request_param_info('removeUsers', 'ExecutionChangeUsers') ->
    #{
        source => body,
        rules => [
            {schema, object, <<"#/components/schemas/ExecutionChangeUsers">>},
...
request_param_info('startScenario', 'ExecutionStart') ->
    #{
        source => body,
        rules => [
            {schema, object, <<"#/components/schemas/ExecutionStart">>},
            required
        ]
    };
request_param_info('updateSettings', 'ExecutionUpdateSettings') ->
    #{
        source => body,
        rules => [
            {schema, object, <<"#/components/schemas/ExecutionUpdateSettings">>},
            required
        ]
    };
request_param_info('getScenarioDescription', 'id') ->
    #{
        source => binding,
        rules => [
            {type, binary},
...
request_param_info('getScenarioSettings', 'id') ->
    #{
        source => binding,
        rules => [
            {type, binary},
...
request_param_info('uploadNewScenario', 'file') ->
    #{
        source => body,
        rules => [
            {type, binary},
...
request_param_info('getAmocAppStatusOnNode', 'node') ->
    #{
        source => binding,
        rules => [
            {type, binary},
