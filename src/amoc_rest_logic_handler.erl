...
-type api_key_callback() ::
    fun((amoc_rest_api:operation_id(), binary()) -> {true, context()} | {false, iodata()}).
-type accept_callback() ::
    fun((amoc_rest_api:class(), amoc_rest_api:operation_id(), cowboy_req:req(), context()) ->
...
-callback api_key_callback(amoc_rest_api:operation_id(), binary()) ->
    {true, context()} | {false, iodata()}.

-callback accept_callback(amoc_rest_api:class(), amoc_rest_api:operation_id(), cowboy_req:req(), context()) ->
    {accept_callback_return(), cowboy_req:req(), context()}.
...
-spec accept_callback(amoc_rest_api:class(), amoc_rest_api:operation_id(), cowboy_req:req(), context()) ->
    {accept_callback_return(), cowboy_req:req(), context()}.
...
-spec provide_callback(amoc_rest_api:class(), amoc_rest_api:operation_id(), cowboy_req:req(), context()) ->
    {cowboy_req:resp_body(), cowboy_req:req(), context()}.
